...
```javascript
import isFloat16Array from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-float16array@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-float16array/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/assert-is-float16array/actions/workflows/test.yml?query=branch:v0.1.1
